...
/*
** Modified by YiBC in 2026 to add Q_RPC_MODULE support.
** Modifications are licensed under the same terms as the original Qt code.
** See LICENSE.GPLv3, LICENSE.LGPLv3 and LICENSE.GPL3-EXCEPT for details.
*/
